...
const IEWarning = () => {
  ...
  return (
    <Dialog onClose={closeIEDialog} aria-labelledby="customized-dialog-title" open={isIE}>
      <DialogTitle>
      ...
      <DialogContent>
        <Typography gutterBottom>
          ...
          <p>
            ...
            guarantee you will have a positive experience using Super Fun Retro. When you are ready to make that move to
            a better browser, Super Fun Retro will be ready for you with open arms!
          </p>
